...
- Create Angular project with ng: `ng new fitnessclassbookingwebapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`fitnessclassbookingwebapp.client.esproj`).
